...
const INSTRUCTIONS = `This server is a persistent, semantically searchable knowledge base backed by MongoDB Atlas Vector Search. Treat it as long-term memory that outlives this conversation and is shared with other agents and sessions.
